/**
 * @file route.ts
 * @description Next.js route handler proxying single-resource operations to the backend.
 * @architecture Authenticates the session, mints a service JWT, and forwards GET/PATCH/DELETE to the Fastify resources API.
 */
...
/**
 * @desc    Proxy GET /api/resources/:resourceId to the backend
 * @param   {NextRequest} req - The incoming request
 * @returns {Promise<NextResponse>} The resource or an error response
 */
...
/**
 * @desc    Proxy PATCH /api/resources/:resourceId to the backend to update a resource
 * @param   {NextRequest} req - The incoming request body
 * @returns {Promise<NextResponse>} The updated resource or an error response
 */
...
/**
 * @desc    Proxy DELETE /api/resources/:resourceId to the backend
 * @param   {NextRequest} req - The incoming request
