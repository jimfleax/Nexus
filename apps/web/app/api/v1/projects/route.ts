/**
 * @file route.ts
 * @description Next.js route handler proxying project list and creation to the backend.
 * @architecture Authenticates the session, mints a service JWT, and forwards GET/POST to the Fastify projects API via the /api/v1 prefix.
 */
...
/**
 * @desc    Proxy GET /api/projects to the backend
 * @param   {NextRequest} req - The incoming request
 * @returns {Promise<NextResponse>} The project list or an error response
 */
...
/**
 * @desc    Proxy POST /api/projects to the backend to create a project
 * @param   {NextRequest} req - The incoming request body
 * @returns {Promise<NextResponse>} The created project or an error response
 */
