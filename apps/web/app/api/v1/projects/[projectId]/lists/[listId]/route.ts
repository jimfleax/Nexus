/**
 * @file route.ts
 * @description Next.js route handler proxying single-list operations to the backend.
 * @architecture Authenticates the session, mints a service JWT, and forwards GET/PATCH/DELETE to the Fastify lists API.
 */
...
/**
 * @desc    Proxy GET /api/lists/:listId to the backend
 * @param   {NextRequest} req - The incoming request
 * @returns {Promise<NextResponse>} The list or an error response
 */
...
/**
 * @desc    Proxy PATCH /api/lists/:listId to the backend to update a list
 * @param   {NextRequest} req - The incoming request body
 * @returns {Promise<NextResponse>} The updated list or an error response
 */
...
/**
 * @desc    Proxy DELETE /api/lists/:listId to the backend
 * @param   {NextRequest} req - The incoming request
