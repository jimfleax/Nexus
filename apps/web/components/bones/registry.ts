/**
 * @file registry.ts
 * @description Automatically generated component registry for boneyard-js.
 * @architecture Registers design system "bones" (UI components) for dynamic instantiation.
 */
"use client";
