...
/**
 * @desc    Dialog popup body with optional close button, composed of portal + overlay
 */
...
/**
 * @desc    Dialog footer row with optional built-in close button
 */
...
/**
 * @desc    Accessible dialog description text
 */
